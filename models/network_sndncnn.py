...
from models.op.conv_sn_chen import conv_spectral_norm
from models.op.bn_sn_chen import bn_spectral_norm

"""
@misc{2019Plug,
  title={Plug-and-Play Methods Provably Converge with Properly Trained Denoisers},
  author={ Ryu, E. K.  and  Liu, J.  and  Wang, S.  and  Chen, X.  and  Wang, Z.  and  Yin, W. },
  year={2019},
}
"""

class SNDnCNN(nn.Module):
    def __init__(self, channels, num_of_layers=17, lip=1.0, no_bn=False):
        super(SNDnCNN, self).__init__()
        kernel_size = 3
        padding = 1
        features = 64
        if lip > 0.0:
